...
@PlanningEntity
public class Sumif2argIncrementalCell<T> extends IncrementalCell<AbstractCellKey, T> {
	public Sumif2argIncrementalCell() {
	}

	public Sumif2argIncrementalCell(AbstractCellKey key, List<AbstractCellKey> predecessors, int numberOfPredecessorLists, IncrementalPredecessorFormula<AbstractCellKey> incrementalPredecessors,
