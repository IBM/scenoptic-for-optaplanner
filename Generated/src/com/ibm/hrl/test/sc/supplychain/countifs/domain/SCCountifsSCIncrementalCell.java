...
@PlanningEntity
public class SCCountifsSCIncrementalCell<T> extends IncrementalCell<AbstractCellKey, T> {
	public SCCountifsSCIncrementalCell() {
	}

	public SCCountifsSCIncrementalCell(AbstractCellKey key, List<AbstractCellKey> predecessors, int numberOfPredecessorLists, IncrementalPredecessorFormula<AbstractCellKey> incrementalPredecessors,
