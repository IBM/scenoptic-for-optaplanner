...
@PlanningEntity
public class SCBoolSCIncrementalCell<T> extends IncrementalCell<AbstractCellKey, T> {
	public SCBoolSCIncrementalCell() {
	}

	public SCBoolSCIncrementalCell(AbstractCellKey key, List<AbstractCellKey> predecessors, int numberOfPredecessorLists, IncrementalPredecessorFormula<AbstractCellKey> incrementalPredecessors,
	...
	@CustomShadowVariable(variableListenerClass = CellListener.class, sources = {
			@PlanningVariableReference(entityClass = SCBoolSCInt1To1500.class, variableName = "value"),
			@PlanningVariableReference(entityClass = SCBoolSCInt1To2000.class, variableName = "value"),
