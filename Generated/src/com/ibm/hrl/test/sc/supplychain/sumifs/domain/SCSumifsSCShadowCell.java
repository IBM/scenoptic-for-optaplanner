...
@PlanningEntity
public class SCSumifsSCShadowCell<T> extends ShadowCell<AbstractCellKey, T> {
	public SCSumifsSCShadowCell() {
	}

	public SCSumifsSCShadowCell(AbstractCellKey key, List<AbstractCellKey> predecessors, Formula formula) {
