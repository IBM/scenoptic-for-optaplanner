...
@PlanningEntity
public class SCBoolSCShadowCell<T> extends ShadowCell<AbstractCellKey, T> {
	public SCBoolSCShadowCell() {
	}

	public SCBoolSCShadowCell(AbstractCellKey key, List<AbstractCellKey> predecessors, Formula formula) {
