package com.ibm.hrl.test.sc.supplychain.sumif.main;
...
import com.ibm.hrl.test.sc.supplychain.sumif.domain.SCSumifSCInt1To1500;
import com.ibm.hrl.test.sc.supplychain.sumif.domain.SCSumifSCInt1To2000;
import com.ibm.hrl.test.sc.supplychain.sumif.domain.SCSumifSCShadowCell;
import com.ibm.hrl.test.sc.supplychain.sumif.domain.SCSumifSCIncrementalCell;
import com.ibm.hrl.test.sc.supplychain.sumif.solver.SCSumifSCSolution;
import com.ibm.hrl.test.sc.supplychain.sumif.solver.SCSumifSCScoreCalculator;

public class SCSumifSCMain extends SpreadsheetOptimizationMain<AbstractCellKey> {
	private static final List<PredecessorCellKey> PREDECESSORS_KEYS = List.of(
            new PredecessorCellKey(new CellKey("Non-neg SUMIF V2", 16, 5),
					List.of()),
            new PredecessorCellKey(new CellKey("Non-neg SUMIF V2", 16, 10),
					List.of()),
            new PredecessorCellKey(new AdHocRangeKey("Non-neg SUMIF V2", 4, 15, 3, 3),
					List.of(new CellDistance("Non-neg SUMIF V2", -1, 1),
                            new CellDistance("Non-neg SUMIF V2", -1, 4))),
            new PredecessorCellKey(new AdHocRangeKey("Non-neg SUMIF V2", 3, 15, 4, 4),
					List.of(new CellDistance("Non-neg SUMIF V2", 0, 4))),
            new PredecessorCellKey(new AdHocRangeKey("Non-neg SUMIF V2", 3, 15, 5, 5),
					List.of(new FixedDistance("Non-neg SUMIF V2", 18, 2),
                            new FixedDistance("Non-neg SUMIF V2", 18, 4),
                            new RangeDistance("Non-neg SUMIF V2", 0, 0, 1, 2))),
            new PredecessorCellKey(new AdHocRangeKey("Non-neg SUMIF V2", 3, 15, 6, 6),
					List.of(new RangeDistance("Non-neg SUMIF V2", 0, 0, -4, -3))),
            new PredecessorCellKey(new AdHocRangeKey("Non-neg SUMIF V2", 3, 15, 7, 7),
					List.of(new RangeDistance("Non-neg SUMIF V2", 0, 0, -5, -4))),
            new PredecessorCellKey(new AdHocRangeKey("Non-neg SUMIF V2", 3, 15, 8, 8),
					List.of(new FixedDistance("Non-neg SUMIF V2", 19, 2),
                            new FixedDistance("Non-neg SUMIF V2", 20, 2),
                            new CellDistance("Non-neg SUMIF V2", 0, -5))));
    ...
    private IncrementalFreshFormula IFF2 = (current, newValues, newScalars) -> getOptionalInt((Integer) current) + (getOptionalInt((Integer) newValues.get(0)) < 0 ? getOptionalInt((Integer) newValues.get(0)) : 0);
    private IncrementalPredecessorFormula<AbstractCellKey> IPF1 = (key, index) -> new com.ibm.hrl.scenoptic.keys.AbstractCellKey[] { new CellKey("Non-neg SUMIF V2", 3 + index, 5) };
    private IncrementalPredecessorFormula<AbstractCellKey> IPF2 = (key, index) -> new com.ibm.hrl.scenoptic.keys.AbstractCellKey[] { new CellKey("Non-neg SUMIF V2", 3 + index, 4) };
    ...
    private IncrementalUpdateFormula IUF2 = (current, previousValues, newValues, previousScalars, newScalars) -> getOptionalInt((Integer) current) - (getOptionalInt((Integer) previousValues.get(0)) < 0 ? getOptionalInt((Integer) previousValues.get(0)) : 0) + (getOptionalInt((Integer) newValues.get(0)) < 0 ? getOptionalInt((Integer) newValues.get(0)) : 0);

	public Stream<AbstractCellKey> getInputInfo() {
	    return Stream.of(
            new CellKey("Non-neg SUMIF V2", 18, 2),
            new CellKey("Non-neg SUMIF V2", 3, 3),
            new CellKey("Non-neg SUMIF V2", 18, 4),
            new AdHocRangeKey("Non-neg SUMIF V2", 3, 15, 2, 2),
            new AdHocRangeKey("Non-neg SUMIF V2", 3, 3, 5, 7));
    }

	public List<DecisionCellInfo<AbstractCellKey>> getDecisionInfo() {
		return List.of(
			new DecisionCellInfo<>(new CellKey("Non-neg SUMIF V2", 19, 2), SCSumifSCInt1To1500::new),
			new DecisionCellInfo<>(new CellKey("Non-neg SUMIF V2", 20, 2), SCSumifSCInt1To2000::new));
    }

	public List<ShadowCellInfo<AbstractCellKey>> getShadowCellInfo() {
		return List.of(
            new ShadowCellInfo<>(new AdHocRangeKey("Non-neg SUMIF V2", 4, 15, 3, 3), CF6),
            new ShadowCellInfo<>(new AdHocRangeKey("Non-neg SUMIF V2", 3, 15, 4, 4), CF2),
            new ShadowCellInfo<>(new AdHocRangeKey("Non-neg SUMIF V2", 4, 15, 5, 5), CF1),
            new ShadowCellInfo<>(new AdHocRangeKey("Non-neg SUMIF V2", 4, 15, 6, 6), CF3),
            new ShadowCellInfo<>(new AdHocRangeKey("Non-neg SUMIF V2", 4, 15, 7, 7), CF4),
            new ShadowCellInfo<>(new AdHocRangeKey("Non-neg SUMIF V2", 3, 15, 8, 8), CF5));
    }
	...
	public List<IncrementalCellInfo<AbstractCellKey>> getIncrementalInfo() {
		return List.of(
			new IncrementalCellInfo<>(new CellKey("Non-neg SUMIF V2", 16, 5), 13, IPF1, IUF1, IFF1, IntegerInitializer.SINGLETON),
			new IncrementalCellInfo<>(new CellKey("Non-neg SUMIF V2", 16, 10), 13, IPF2, IUF2, IFF2, IntegerInitializer.SINGLETON));
	}
	...
	public ShadowCell<AbstractCellKey, ?> createShadowVariable(AbstractCellKey key, List<AbstractCellKey> predecessors, Formula formula) {
		return new SCSumifSCShadowCell<>(key, predecessors, formula);
	}
	...
	public IncrementalCell<AbstractCellKey, ?> createIncrementalVariable(
		...
		return new SCSumifSCIncrementalCell<>(key, predecessors, numberOfPredecessorLists, incrementalPredecessors, incrementalUpdateFormula, incrementalFreshFormula, initializer);
	}
	...
	public SpreadsheetProblem<AbstractCellKey> createSolution(
		...
		return new SCSumifSCSolution(decisions, cells, inputs, incrementals, summingCells);
	}

	@Override
	public Class<? extends SpreadsheetProblem<AbstractCellKey>> getSolutionClass() {
		return (Class<? extends SpreadsheetProblem<AbstractCellKey>>) SCSumifSCSolution.class;
	}

	@Override
	public Class<Cell<AbstractCellKey, ?>>[] getEntityClasses() {
		return new Class[] { SCSumifSCInt1To1500.class, SCSumifSCInt1To2000.class,  SCSumifSCShadowCell.class, SCSumifSCIncrementalCell.class };
	}
	...
	public Class<? extends EasyScoreCalculator<? extends SpreadsheetProblem<AbstractCellKey>, BendableScore>> getScoreCalculatorClass() {
		return SCSumifSCScoreCalculator.class;
	}

	public static void main(String[] args) throws ArgumentParserException {
		new SCSumifSCMain().mainBody(args, PREDECESSORS_KEYS);
	}
}
