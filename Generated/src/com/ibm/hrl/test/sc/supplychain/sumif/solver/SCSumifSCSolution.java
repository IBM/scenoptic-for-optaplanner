...
@PlanningSolution
public class SCSumifSCSolution<K extends Comparable<K>> extends SpreadsheetProblem<K> {
	@PlanningScore(bendableHardLevelsSize = 1, bendableSoftLevelsSize = 1)
	private BendableScore score;

	// No-arg constructor required for OptaPlanner
	public SCSumifSCSolution() {
	}

	public SCSumifSCSolution(List<? extends PlanningCell<K, Integer>> decisions,
