...
@PlanningSolution
public class ScalarsSolution<K extends Comparable<K>> extends SpreadsheetProblem<K> {
	@PlanningScore(bendableHardLevelsSize = 0, bendableSoftLevelsSize = 1)
	private BendableScore score;

	// No-arg constructor required for OptaPlanner
	public ScalarsSolution() {
	}

	public ScalarsSolution(List<? extends PlanningCell<K, Integer>> decisions,
