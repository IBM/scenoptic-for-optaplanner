...
@PlanningSolution
public class AggregateSolution<K extends Comparable<K>> extends SpreadsheetProblem<K> {
	@PlanningScore(bendableHardLevelsSize = 0, bendableSoftLevelsSize = 4)
	private BendableScore score;

	// No-arg constructor required for OptaPlanner
	public AggregateSolution() {
	}

	public AggregateSolution(List<? extends PlanningCell<K, Integer>> decisions,
	...
	public ValueRange<Integer> getInt0To11Range() {
		return ValueRangeFactory.createIntValueRange(0, 11);
	}

	@ValueRangeProvider(id = "Int0To3")
	public ValueRange<Integer> getInt0To3Range() {
