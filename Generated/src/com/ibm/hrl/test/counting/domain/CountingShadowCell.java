...
@PlanningEntity
public class CountingShadowCell<T> extends ShadowCell<AbstractCellKey, T> {
	public CountingShadowCell() {
	}

	public CountingShadowCell(AbstractCellKey key, List<AbstractCellKey> predecessors, Formula formula) {
