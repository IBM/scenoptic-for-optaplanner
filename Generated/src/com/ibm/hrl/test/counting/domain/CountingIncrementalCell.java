...
@PlanningEntity
public class CountingIncrementalCell<T> extends IncrementalCell<AbstractCellKey, T> {
	public CountingIncrementalCell() {
	}

	public CountingIncrementalCell(AbstractCellKey key, List<AbstractCellKey> predecessors, int numberOfPredecessorLists, IncrementalPredecessorFormula<AbstractCellKey> incrementalPredecessors,
