...
@PlanningEntity
public class ComplexShadowCell<T> extends ShadowCell<AbstractCellKey, T> {
	public ComplexShadowCell() {
	}

	public ComplexShadowCell(AbstractCellKey key, List<AbstractCellKey> predecessors, Formula formula) {
