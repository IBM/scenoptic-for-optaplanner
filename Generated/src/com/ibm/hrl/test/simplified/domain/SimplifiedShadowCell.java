...
@PlanningEntity
public class SimplifiedShadowCell<T> extends ShadowCell<AbstractCellKey, T> {
	public SimplifiedShadowCell() {
	}

	public SimplifiedShadowCell(AbstractCellKey key, List<AbstractCellKey> predecessors, Formula formula) {
