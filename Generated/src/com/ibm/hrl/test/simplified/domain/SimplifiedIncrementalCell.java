...
@PlanningEntity
public class SimplifiedIncrementalCell<T> extends IncrementalCell<AbstractCellKey, T> {
	public SimplifiedIncrementalCell() {
	}

	public SimplifiedIncrementalCell(AbstractCellKey key, List<AbstractCellKey> predecessors, int numberOfPredecessorLists, IncrementalPredecessorFormula<AbstractCellKey> incrementalPredecessors,
	...
	@CustomShadowVariable(variableListenerClass = CellListener.class, sources = {
			@PlanningVariableReference(entityClass = SimplifiedInt0To11.class, variableName = "value"),
