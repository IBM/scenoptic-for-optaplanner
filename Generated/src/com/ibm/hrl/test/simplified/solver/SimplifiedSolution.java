...
@PlanningSolution
public class SimplifiedSolution<K extends Comparable<K>> extends SpreadsheetProblem<K> {
	@PlanningScore(bendableHardLevelsSize = 0, bendableSoftLevelsSize = 1)
	private BendableScore score;

	// No-arg constructor required for OptaPlanner
	public SimplifiedSolution() {
	}

	public SimplifiedSolution(List<? extends PlanningCell<K, Integer>> decisions,
